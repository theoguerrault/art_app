...
<div class="admin-view">
  <header class="admin-header sticky-header">
    <h1 class="page-title">Administration des Mouvements</h1>
  ...
  <div class="items-grid">
    {#each data.movements as movement (movement.id)}
      {@const translation = movement.movement_translations?.[0]}
      {@const status = translation?.verification_status?.toUpperCase()}
      <a data-sveltekit-preload-data="hover" href={`/admin/movements/${movement.id}`} class="item-card">
        ...
        <div class="card-body">
          <h2 class="card-title">{(translation?.name || movement.slug || '')}</h2>
